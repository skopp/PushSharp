...
namespace PushSharp.Sample
{
	class Program
	{
		...
		{		
			...
			push.StartService(PlatformType.Apple, new ApplePushChannelSettings(appleCert, "pushsharp"));
            ...
            push.StartService(PlatformType.AndroidGcm, new GcmPushChannelSettings("785671162406", "AIzaSyC2PZNXQDVaUpZGmtsF_Vp8tHtIABVjazI", "com.pushsharp.test"));

            //Configure and start Windows Phone Notifications
            push.StartService(PlatformType.WindowsPhone, new WindowsPhonePushChannelSettings());

			//Configure and start Windows Notifications
			push.StartService(PlatformType.Windows, new WindowsPushChannelSettings("677AltusApps.PushSharpTest",
            ...
            push.QueueNotification(WindowsNotification.CreateToast().AsToastText01("This is a test").ForChannelUri("YOUR_CHANNEL_URI_HERE"));
            ...
            push.QueueNotification(WindowsPhoneNotification.CreateToast()
            ...
            push.QueueNotification(AppleNotification.Create()
            ...
            push.QueueNotification(GcmNotification.Create()
			...
			push.QueueNotification(WindowsNotification.CreateToast()
